...
public class HomebankingApplication {
	...
	public CommandLineRunner initData(ClientRepository clientRepository, AccountRepository accountRepository, TransactionRepository transactionRepository, LoanRepository loanRepository, ClientLoanRepository clientLoanRepository,
		...
		return (args) -> {
			...
			Account cuenta1 = new Account("VIN001", LocalDateTime.now(), 5000.00, client1);
			Account cuenta2 = new Account("VIN002", LocalDateTime.now().plusDays(1), 00.00, client1);
			Card cardMelba = new Card(client1, CardType.DEBIT, CardColor.GOLD, "5223 2602 9373 6997", 125, LocalDate.now(), LocalDate.now().plusYears(5));
			Card cardMelba2 = new Card(client1, CardType.CREDIT, CardColor.TITANIUM, "5405 9120 0735 7771", 158, LocalDate.now(), LocalDate.now().plusYears(5));
			...
			Card cardClient2 = new Card(client2, CardType.CREDIT, CardColor.SILVER, "5405 9120 0735 7771", 175, LocalDate.now(), LocalDate.now().plusYears(4));
			...
			//Client Admin = new Client("admin","admin","admin@bbm.com",passwordEncoder.encode("admin"));
