    ...
    methods: {
        ...
        loadLoans(){
            axios.get("/api/loans").then((e) =>{
                ...
                this.loanAutomotriz = this.loanTypes.filter(loan=>loan.nameLoan == "Automotriz")
                this.loanHipotecario = this.loanTypes.filter(loan =>loan.nameLoan=="Hipotecario")
                this.loanPersonal = this.loanTypes.filter(loan =>loan.nameLoan == "Personal")
        ...
        createLoan(){
              Swal.fire({
                ...
                axios.post("/api/loans", {amount:this.newAmount,nameLoan:this.loanNameChoose, payment:this.newPaymentLoan, numbAccount:this.accDestiny})
                .then(() => Swal.fire("Your loan has been requested","","success"))
